  ...
  return (
    <Sidebar collapsible="icon" className="overflow-hidden" {...props}>
      ...
      >
        ...
        <SidebarContent className="@container relative my-0 max-h-svh pt-2 pb-0 group-data-[collapsible=icon]:invisible [&>button]:hidden overflow-y-auto overflow-y-hidden">
